...
public class ItemAdapter extends Adapter<ItemAdapter.ViewHolder> {
    ...
    public static ItemAdapter getInstance() {
        if (instance == null) instance = new ItemAdapter();
        return instance;
    }

    public static void refreshInstance(List<CollectionInfo> list) {
        instance = new ItemAdapter(list);
    }
    ...
    public ItemAdapter(List<CollectionInfo> data) {
        this.data = data;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        CollectionInfo collectionInfo = data.get(position);
        viewHolder.title.setText("<html><u>" + collectionInfo.getTitle() + "</u></html>");
        viewHolder.link.setText(collectionInfo.getLink());
        viewHolder.labels.setText(Arrays.stream(collectionInfo.getLabels()).collect(Collectors.joining("，")));
