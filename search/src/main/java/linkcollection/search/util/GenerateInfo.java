package linkcollection.search.util;


import linkcollection.search.entity.LinkCheckInfo;

public final class GenerateInfo {

    public static final LinkCheckInfo generateLinkCheckInfo(String link) {
        long headId;
        int tailId;
        ...
        // 要生成的尾部标识
        String tail = link.substring(tailIndex);
        // 要生成的头部标识
        String head = link.substring(0, tailIndex);
        // 当前头部部分的长度
        ...
        return new LinkCheckInfo(headId, tailId, link);
    }
